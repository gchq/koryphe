...
public class If<I, O> extends KorypheFunction<I, O> {
    ...
    public If<I, O> predicate(final Predicate<?> predicate) {
    ...
    public void setThen(final Function<?, ?> then) {
        this.then = (Function) then;
    }

    public If<I, O> then(final Function<?, ?> then) {
        setThen(then);
        return this;
    }
    ...
    public void setOtherwise(final Function<?, ?> otherwise) {
        this.otherwise = (Function) otherwise;
    }

    public If<I, O> otherwise(final Function<?, ?> otherwise) {

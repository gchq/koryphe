...
/**
 * A <code>ToLowerCase</code> is a {@link java.util.function.Function} that takes
 * an Object and performs <code>toLowerCase</code> on it.
 * <p>
 * The resulting object is what is returned from the method.
 */
@Since("1.5.0")
@Summary("performs toLowerCase on an input Object")
